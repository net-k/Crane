...
public class AudioManager : MonoBehaviour {
	...
	//------------------------------------------------------------------------------------------------------------------------
	public void PlayBGM(AudioNo audioNo)
	{
		PlayBGM((int)audioNo);
	}
	
	private void PlayBGM(int inputNumber)
	{
		return;
	...
	public void StopBGM(AudioNo audioNo)
	{
		StopBGM((int)audioNo);
	}

	private void StopBGM(int inputNumber)
	{
		return;
	...
	public void PlaySound(AudioNo audioNo)
	{
		return;
		PlaySound( (int)audioNo);
	}
	private void PlaySound(int inputNumber)
	{
		if(audioSource[inputNumber].isPlaying == true)
		{
			audioSource[inputNumber].Stop();
